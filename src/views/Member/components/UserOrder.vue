...
const pageChange = (page) => {
    ...
    //这里传来的page与currentPage似乎不同步
    //  currentPage与按钮颜色绑定，page与当前页数绑定(或者是currentPage不会随着点击事件改变，而page会)
      ...
      <div class="main-container">
        ...
        <div v-else>
          ...
          <div class="pagination-container">
            <el-pagination :total="total" @current-change="pageChange" :current-page="currentPage"
              :pageSize="params.pageSize" background layout="prev, pager, next" />
          </div>
        </div>
      </div>
